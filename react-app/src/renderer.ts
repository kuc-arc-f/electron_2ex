import ExportGantt from "./client/TaskProject/ExportGantt"
console.log("renderer.ts");
import "./index.tsx";

//const data = await window.myGetSysParams.getSysParams();
